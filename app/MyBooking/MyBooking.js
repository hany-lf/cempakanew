    ...
    getListBooking = () =>{
        ...
        {isMount ?
            this.state.project.map((val)=>{
                fetch(urlApi+'c_booking/getListBooking/'+val.db_profile+'/'+this.state.name+'/'+val.entity_cd+'/'+val.project_no,{
                    method:'GET',
                ...
                .then((res)=>{
                    ...
                    console.log('getListBooking',res);
                }).catch((error) => {
                    console.log(error);
                })
            })
