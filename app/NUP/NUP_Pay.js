...
class NUPPage extends Component {
  ...
  onNext(step) {
    const {name, email, no_hp, ktp, fotoKtp, fotoNpwp, npwp, buktibayar} =
      this.state;
      ...
      <Container style={Style.bgMain}>
        <Header style={Style.navigation}>
          ...
          <View style={Style.actionBarMiddle}>
            <Text style={Style.actionBarText}>{'NUP'.toUpperCase()}</Text>
          </View>
            ...
            >
              <View>
                ...
                <Item rounded style={styles.nbInput} style={Styles.marginround}>
                  ...
                  <Input
                    placeholder="No Hp Alternative"
                    value={this.state.no_hp_alt}
                    onChangeText={no_hp_alt => this.setState({no_hp_alt})}
                    style={Styles.positionTextInput}
                  />
                </Item>
                ...
                <Item rounded style={styles.nbInput} style={Styles.marginround}>
                  <View
                    ...
                    <Icon
                      name="phone"
                      type="FontAwesome5"
                      style={{color: Colors.navyUrban, left: 15, fontSize: 18}}
                    />
                  </View>

                  <Input
                    placeholder="No Telp Alternative"
                    value={this.state.no_telp_alt}
                    onChangeText={no_telp_alt => this.setState({no_telp_alt})}
                    style={Styles.positionTextInput}
                  />
                </Item>
                ...
                <Item rounded style={styles.nbInput} style={Styles.marginround}>
                  ...
                  <Input
                    ...
                    onChangeText={npwp => this.setState({npwp})}
                    style={Styles.positionTextInput}
                  />
                </Item>
                      ...
                      <View style={[styles.avatar, styles.avatarContainer]}>
                        ...
                        this.state.buktibayar == '' ? (
                          ...
                          <Image
                            resizeMode="cover"
                            style={styles.avatar}
                            source={this.state.buktibayar}
                          />
                        )}
                        <Text style={styles.label}>Upload Bill Payment</Text>
                      </View>
                    </TouchableOpacity>
                  </View>
                </View>
            ...
            <ProgressStep
              ...
              <ScrollView contentContainerStyle={{alignItems: 'center'}}>
                <View style={styles.container}>
                  {/* <Text>{this.state.progress}</Text> */}
                  <TouchableOpacity onPress={() => this.showAlert('fotoKtp')}>
                    <View style={[styles.avatar, styles.avatarContainer]}>
                      {/* <Image
                                                resizeMode="cover"
                                                style={styles.avatar}
                      ...
                      <Text style={styles.label}>Upload ID Card (KTP)</Text>
                    </View>
                  </TouchableOpacity>
                </View>
                ...
                <View style={[styles.container, {marginTop: 5}]}>
                  {/* <Text>{this.state.progress}</Text> */}
                  <TouchableOpacity onPress={() => this.showAlert('fotoNpwp')}>
                    <View style={[styles.avatar, styles.avatarContainer]}>
                      {/* <Image
                                                resizeMode="cover"
                                                style={styles.avatar}
            ...
            <ProgressStep
              ...
              <View style={{marginHorizontal: 10}}>
                <Card>
                  <CardItem
                    header
                    style={{borderBottomWidth: 1 / PixelRatio.get()}}>
                  ...
                  <CardItem>
                    ...
                    <Right>
                      <Text>
                        Rp. {numFormat(Math.round(this.state.nupprice))}
                      </Text>
                    </Right>
                  </CardItem>
                  <CardItem>
                  ...
                  <CardItem>
                    ...
                    <Right>
                      <Text>
                        Rp. {numFormat(this.state.nupprice * this.state.nupqty)}
                      </Text>
                    </Right>
                  </CardItem>
                </Card>
