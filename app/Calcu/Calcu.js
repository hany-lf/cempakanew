          ...
          <View>
            <View style={styles.overview}>
              <TextInput
                ...
                onChangeText={val =>
                  this.setState({totalCredit: this.format(val)})
                }
              />
            ...
            {this.state.isCount ? (
              <View style={styles.overviewResult}>
                <Text style={styles.countText}>JUMLAH ANGSURAN (PERBULAN)</Text>
                <Text style={styles.numResultText}>{this.state.angsuran}</Text>
              </View>
            ) : null}
            <View style={styles.overview}>
              <Text style={styles.countText}>
                * Angka di atas merupakan angka estimasi, untuk lebih akuratnya
                mohon hubungi bank terkait.
              </Text>
            </View>
          </View>
        </ScrollView>
