...
class Feed extends Component {
  ...
  async componentDidMount() {
    ...
    console.log('project', await _getData('@User'));
    this.setState(data, () => {
      this.getNews();
    });
  }
  ...
  getNews = () => {
    console.log('dummyPromo', dummyPromo);
    this.setState({news: dummyPromo.data});
    ...
    //     ? fetch(
    //         urlApi +
    //           'c_newsandpromo/getDataNewsAndPromo/IFCAMOBILE/' +
    //           (this.state.type.length > 0 ? this.state.type : '-'),
    //         {
    //           method: 'POST',
