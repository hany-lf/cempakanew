...
class AddInterest extends Component {
    ...
    getEntity = async(zoomproject) =>{
        ...
        console.log('zoom project when project no is null', {project_no:zoomproject});
        {isMount ?
    ...
    renderRow = ({item}) => {
        ...
        return(
            // <TouchableOpacity >
            <ListItem style={{height: 20, marginVertical: 1}} 
            ...
            // }}
            >
                <Text style={{fontFamily: "Montserrat-Regular",color: "#333",paddingBottom: 8, paddingTop: 8, fontSize: 15}}>
                {item.value}
                </Text>
            </ListItem>
    ...
    updateSearch = search => {
        ...
        const newData = this.arrayholder.filter(function(item) {  //bisa juga pakai getlot
                ...
                <Content>
                    <View>                       
                        <View style={{ paddingVertical: 10}}  pointerEvents='none'>
                            ...
                            <TextInput style={Styles.textInput_medium} placeholder={'Prospect ID'} value={this.state.business_id} onChangeText={(text) => this.setState({ business_id: text })} />
                        </View>
                             ...
                             {Platform.OS == "ios" ?
                                 <TouchableOpacity onPress={()=>this.showActionSheet()} style={{borderWidth: 1, borderColor: "#333"}}>
                                     <View pointerEvents="none">
                                         <TextInput style={Styles.textInput}  placeholder={'Project Name'} value="" />
                                     </View>
                                 </TouchableOpacity>
                             :
                                    ...
                                    <View style={{
                                        ...
                                        {/* loadmore looping in here */}
                                            ...
                                            <View style={{height: 300}}> 
                                                ...
                                                />
                                                <FlatList 
                                                style={{  marginTop: 10, marginBottom: 20, marginRight: 20}}
