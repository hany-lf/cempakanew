    ...
    componentWillUnmount(){
      ...
      async createPDF() {
        let options = {
          //Content to print
          html:
            '<h1 style="text-align: center;"><strong>Hello Guys</strong></h1><p style="text-align: center;">Here is an example of pdf Print in React Native</p><p style="text-align: center;"><strong>Team About React</strong></p>' + this.state.email,
          //File Name
          fileName: 'test',
          //File directory
          directory: 'downloads',
                ...
                <List style={{paddingVertical: 10}} >
                    ...
                    {this.state.detail.map((data, key) => (
                        //  <TouchableOpacity key={key} style={navStyles.newsContainer} onPress={()=>this.DetailProspect(data)}>
                         <ListItem  style={navStyles.newsContainer} onPress={()=>this.DetailProspect(data) } key={key}>                                
                            <View style={{alignSelf:'flex-start'}} >
                                ...
                                <Text style={{fontFamily: "Montserrat-Regular",alignSelf:'flex-start',color: "#333",marginBottom: 5,fontSize: 15}}>Follow Up Date : {data.entry_date}</Text>
                            </View>
