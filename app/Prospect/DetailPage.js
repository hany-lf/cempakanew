...
class DetailPage extends Component {
    ...
    constructor(props){
        ...
        this.renderAccordionContentFollowup = this.renderAccordionContentFollowup.bind(this)
                    ...
                    <View>
                        ...
                        <View style={{paddingVertical: 10}} pointerEvents={this.state.disableprospect ? 'none' : 'auto'}>
                            ...
                            <Item rounded style={{height: 35}}>
                                ...
                                // onValueChange={(VIP)=>this.changeformvip(VIP)}
                                enabled={this.state.disableprospect ? this.state.makafalse  : this.state.makatrue} 
                                >
    ...
    renderAccordionContentDetail() {
        ...
        let {salutation,name,addr1,addr2,addr3,post_cd,district,village,city,province_cd,tel_no,hp,hp2,handphone,email_addr,salutation_cd,category} = this.state
        return <View style={Styles.overview_detail}>
                    <View style={{justifyContent: "flex-end", flexDirection: "row"}}>
                    ...
                    <View>
                        ...
                        <View>
                            ...
                            <View style={{ paddingVertical: 10}} pointerEvents={this.state.disabledetailindividu ? 'none' : 'auto'} >
                                ...
                                <TextInput style={this.state.disabledetailindividu ? Styles.textInput_disable : Styles.textInput } enabled={this.state.disabledetailindividu ? this.state.makafalse  : this.state.makatrue} placeholder={'Address'} value={addr1} maxLength={60} onChangeText={(val)=>{this.setState({addr1:val})}}/>
                                <TextInput style={this.state.disabledetailindividu ? Styles.textInput_disable : Styles.textInput } enabled={this.state.disabledetailindividu ? this.state.makafalse  : this.state.makatrue} placeholder={'Address'} value={addr2} maxLength={60} onChangeText={(val)=>{this.setState({addr2:val})}}/>
                                <TextInput style={this.state.disabledetailindividu ? Styles.textInput_disable : Styles.textInput } enabled={this.state.disabledetailindividu ? this.state.makafalse  : this.state.makatrue} placeholder={'Address'} value={addr3} maxLength={60} onChangeText={(val)=>{this.setState({addr3:val})}}/>
                            </View>
                            <View style={{ paddingVertical: 10}} pointerEvents={this.state.disabledetailindividu ? 'none' : 'auto'} >
                                <Label>
                            ...
                            <View style={{ paddingVertical: 10}} pointerEvents={this.state.disabledetailindividu ? 'none' : 'auto'} >
                                ...
                                <TextInput style={this.state.disabledetailindividu ? Styles.textInput_disable : Styles.textInput } enabled={this.state.disabledetailindividu ? this.state.makafalse  : this.state.makatrue} placeholder={'Email'} value={email_addr} onChangeText={(val)=>{this.setState({email_addr:val})}}/>
                            </View>
                        </View>
                        }
                    </View>
                    ...
                    <View>
                        ...
                        <View>
                            ...
                            <View style={{ paddingVertical: 10}} pointerEvents={this.state.disabledetailcompany ? 'none' : 'auto'} >
                                ...
                                <TextInput style={this.state.disabledetailcompany ? Styles.textInput_disable : Styles.textInput } enabled={this.state.disabledetailcompany ? this.state.makafalse  : this.state.makatrue} placeholder={'Email'} value={email_addr} onChangeText={(val)=>{this.setState({email_addr:val})}}/>
                            </View>
                            <View style={{ paddingVertical: 10}} pointerEvents={this.state.disabledetailcompany ? 'none' : 'auto'} >
                                <View style={{ flexDirection: 'row', alignItems: 'flex-start' }}>
                                    <Icon solid name='star' style={Styles.iconSub2} type="FontAwesome5" />
                        ...
                        <ScrollView>
                            ...
                            {/* {this.state.status.length == 0 ?  */}
                                ...
                                {this.state.datafollowup.map((data, key) => (
                                    <TouchableOpacity style={{width: '100%'}} onPress={() => this.DetailFollowUp(data)}
                                    key={key}
                                    >
                                    <Card style={{
                                        height: null,
        ...
        return (
            <Container style={Style.bgMain}>
                ...
                >
                    ...
                    {/* </Content> */}
                    <View>
                    <View style={{borderTopColor: '#333', borderTopWidth: 1, borderStyle: "solid",borderBottomColor: '#333', borderBottomWidth: 1, borderStyle: "solid"}}>
